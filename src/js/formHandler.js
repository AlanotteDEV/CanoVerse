...
const CATEGORY_NOTES = {
  ...
  tcg_onepiece: 'Quota di iscrizione: 8 €, da saldare in loco. In palio la carta winner di Luffy dell\'espansione OP-17, che va al vincitore del torneo. Formato, ban-list e cosa portare al tavolo sono in fase di definizione: li pubblicheremo sul sito e ti avviseremo appena disponibili.',
};
