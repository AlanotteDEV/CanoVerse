...
const CATEGORY_NOTES = {
  ...
  tcg_onepiece: 'Quota di iscrizione: 8 €, da saldare in loco. In palio la carta Pre-Release Winner OP17 "Luffy Lego", che va al vincitore del torneo. Formato, ban-list e cosa portare al tavolo sono in fase di definizione: li pubblicheremo sul sito e ti avviseremo appena disponibili.',
};
