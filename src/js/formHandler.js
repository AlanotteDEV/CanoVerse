...
const CATEGORY_NOTES = {
  cosplay_singolo: 'IMPORTANTE — invia a Canoversecomicscosplay@gmail.com l\'immagine del personaggio che interpreti e, se vuoi esibirti su una tua musica, la base audio o video. La traccia è facoltativa: chi non la manda si esibisce su una base scelta dall\'organizzazione. Dopo la chiusura delle iscrizioni non è più possibile cambiare personaggio, traccia o ordine di esibizione.\nLa gara è alle 19:00 e la tua esibizione dura al massimo 2 minuti: allo scadere viene interrotta.\nPremi: miglior cosplay assoluto, buono Amazon da 40 €; miglior coppia o gruppo, gift card Manbaga da 30 €; menzione speciale CanoVerse, premio dedicato.',
  cosplay_gruppo: 'IMPORTANTE — invia a Canoversecomicscosplay@gmail.com l\'immagine dei personaggi interpretati e, se volete esibirvi su una vostra musica, la base audio o video. La traccia è facoltativa: chi non la manda si esibisce su una base scelta dall\'organizzazione. Dopo la chiusura delle iscrizioni non è più possibile cambiare personaggi, traccia, ordine di esibizione o composizione del gruppo.\nLa gara è alle 19:00 e l\'esibizione dura al massimo 4 minuti: allo scadere viene interrotta.\nPremi: miglior coppia o gruppo, gift card Manbaga da 30 €; concorrete anche al miglior cosplay assoluto (buono Amazon da 40 €) e alla menzione speciale CanoVerse, con un premio dedicato.',
